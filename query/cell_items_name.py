...
def income_statement_sheet():
   income_statement_sheet_table={
      1 : [u'營業收入合計'],
      2 : [u'營業成本合計'], 
      3 : [u'營業毛利（毛損）淨額'], 
      ...
      9 : [u'母公司業主（淨利／損）'],
      10 : [u'基本每股盈餘合計'],}
   return income_statement_sheet_table

def cash_flow_sheet():
   cash_flow_sheet_table={
      1 : [u'營業活動之淨現金流入（流出）'],
      2 : [u'投資活動之淨現金流入（流出）'], 
      3 : [u'籌資活動之淨現金流入（流出）'], 
      4 : [u'匯率變動對現金及約當現金之影響'],
      ...
      6 : [u'期初現金及約當現金餘額'],
      7 : [u'期末現金及約當現金餘額'],}
   return cash_flow_sheet_table

def value_estimate_sheet():
   value_estimate_table ={
      1 : [u'Name'],
      2 : [u'ID'],
      3 : [u'Group'],
      4 : [u'資產總計'],
